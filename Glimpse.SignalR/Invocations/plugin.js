...
(function ($, pubsub, util, elements, data, renderEngine) {
    ...
    var context = { resultCount: 0, notice: null, isActive: false, contextRequestId: null, isSelected: false },
        ...
        wireListeners = function () {
            var panel = elements.panel('ajax2');
        ...
        setup = function (args) {
            args.newData.data.ajax2 = { name: 'Ajax2', data: 'No requests currently detected...', isPermanent: true };
            args.newData.metadata.plugins.ajax2 = { documentationUri: 'http://getglimpse.com/Help/Ajax-Tab' };
        },
        activate = function () {
        ...
        contextSwitch = function (args) {
            ...
            if (oldId != newId) {
                elements.panel('ajax2').find('tbody').empty();
        ...
        layoutClear = function () {
            ...
            elements.panel('ajax2').html('<div class="glimpse-panel-message">No requests currently detected...</div>');
        },
        ...
        selectStart = function (args) {
            var link = elements.panel('ajax2').find('.glimpse-ajax-link[data-requestId="' + args.requestId + '"]'),
